...
["catch",[
 ...
 {n:"Pikachu", t:["Electric"], where:"Viridian Forest — 5%, in both versions", why:"<b>This is not your partner and it is not version-exclusive</b> — wild Pikachu spawn here in Let’s Go, Eevee! too, just as wild Eevee spawn on Route 17 in yours. Only the <i>partner</i> is locked to the box you bought. A wild one has ordinary Pikachu stats, and it is the species the Saffron trade wants, once evolved with a Thunder Stone, for an <b>Alolan Raichu</b>."},
 {n:"Butterfree", t:["Bug","Flying"], lgv:true, where:"Viridian Forest — 1%, and only in your version", why:"<b>The spawn is exclusive, not the species</b> — Eevee players see a 1% Beedrill in this slot but can still raise a Caterpie like anyone else. A fully evolved catch at level 3–6 is free experience and saves you the grind."},
...
["catch",[
 ...
 {n:"Persian", t:["Normal"], lgv:true, where:"Free from the Black Belt west of the Poké Mart, after catching five Growlithe", why:"<b>Do this errand. It is the best quality-of-life reward in the game.</b> This Persian can be <i>ridden</i>, which moves you faster than running for the rest of the run. <b>The gift is version-locked, the species is not</b> — Eevee players reach Persian by evolving a Meowth, and their errand pays out a rideable Arcanine instead."},
