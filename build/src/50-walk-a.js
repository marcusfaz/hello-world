...
["do",[
 ...
 {t:"Take the stairs south of the Petalburg entrance down to the beach", sub:"<b>Route 104 is split in two by Petalburg Woods.</b> This southern half runs from Petalburg City to the woods; the flower shop and the pond are on the far side."},
 {t:"Note <b>Mr. Briney's cottage</b> and the pier at the north-west end of the beach", sub:"<b>The cottage is on the southern half</b>, by the sea. You come back here for a boat ride to Dewford in two stages."},
 {t:"Sweep the beach for the hidden <b>Antidote</b>, <b>Potion</b> and <b>Heart Scale</b>", sub:"The Heart Scale is just south-east of the Fisherman. Heart Scales buy back forgotten moves later."},
 {t:"Take the <b>Oran</b> and <b>Pecha Berries</b> from the soft soil north of the cottage"},
 {t:"Head north into <b>Petalburg Woods</b>"},
 ...
 {at:"Route 104 north", t:"Leave the woods — the <b>Pretty Petal flower shop</b> is right by the exit", sub:"<b>This is the northern half of Route 104</b>, on the far side of the woods from the beach. The path branches west to the shop and east along the pond to Rustboro."},
 {t:"Take <b>TM09 Bullet Seed</b> from the Youngster <b>south of the flower shop</b>", sub:"The boy stands just below the shop — but the shop itself is on Route 104 <i>north</i>. There is no flower shop on the beach side."},
 {t:"Take the free <b>Wailmer Pail</b> from the middle sister inside the shop", sub:"It is what waters your berries. The youngest sister hands out one random berry a day, so call in whenever you pass."},
 {t:"Plant a berry in the soft soil beside the shop", sub:"Berries are the only renewable healing item in Hoenn and the only route to Pokéblocks."},
 {t:"Take the hidden <b>Poké Ball</b> and <b>Super Potion</b> in the grass behind the shop"},
 {t:"Follow the pond east, then north across the bridge", sub:"The <b>X Accuracy</b> by the pond's south-east corner needs Cut, and the <b>PP Up</b> across the water needs Surf. Both wait."},
 {t:"Take the <b>Chesto Berry</b> from the old woman by the soft soil east of the bridge"},
 {t:"Walk north-west into Rustboro City"}
]],
["h","Worth catching now"],
["catch",[
...
["do",[
 ...
 {t:"Talk to the teacher in the <b>Pokémon Trainer's School</b> for a free <b>Quick Claw</b>", sub:"The school is north-east of the Pokémon Center."},
 ...
 {t:"Walk back south through Petalburg Woods to <b>Mr. Briney's cottage</b> on <b>Route 104 south</b>", sub:"Back through the woods and down to the beach — the cottage is on the southern half, not the flower-shop side."},
...
["do",[
 ...
 {at:"Dewford Town", t:"Talk to the boy <b>outside Dewford Hall</b> and learn the trendy phrase", sub:"Dewford Hall is north of the Pokémon Center, and the phrase set here is what decides <b>which six water tiles on Route 119 hold Feebas</b> much later. Say hello now so you know how the system works."},
 {t:"Take the <b>Old Rod</b> from the Fisherman on the <b>east side of the Dewford Gym</b>", sub:"Answer his question and it is yours. Magikarp and Tentacool only, but it is the first rod and several dex entries are water-only."},
 ...
 {at:"Granite Cave (second visit)", t:"Use <b>Flash</b> and work down through 1F, B1F and B2F"},
 {t:"Give the <b>Letter</b> to <b>Steven</b> in the innermost room", sub:"Steven's room is the deepest part of the cave — the layout makes you cross every floor to reach it."},
